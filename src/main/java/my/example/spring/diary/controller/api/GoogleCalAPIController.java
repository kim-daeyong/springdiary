package my.example.spring.diary.controller.api;


import my.example.spring.diary.dto.CalDto;
import my.example.spring.diary.service.GoogleCalService;
...
@RestController
public class GoogleCalAPIController {
    ...
    public class CalendarAjaxController {
        ...
        public List<Event> calendarEventList(CalDto calDto) {
            logger.info("calendarEventList "+calDto.toString());

            List<Event> items = new ArrayList<Event>();
            try {
                com.google.api.services.calendar.Calendar service = GoogleCalService.getCalendarService();
        ...
        public Map<String, Boolean> calendarEventAdd(CalDto calDto) {
            logger.info("calendarEventAdd "+calDto.toString());

            boolean isc = false;
            try {
                Calendar service = GoogleCalService.getCalendarService();
                Event event = new Event().setSummary(calDto.getSummary()).setDescription(calDto.getDescription());
                //시작일
                DateTime startDateTime = new DateTime(calDto.getStartDate());
                EventDateTime start = new EventDateTime().setDateTime(startDateTime).setTimeZone("America/Los_Angeles");
                event.setStart(start);
                //종료일
                DateTime endDateTime = new DateTime(calDto.getEndDate());
        ...
        public Map<String, Boolean> calendarEventRemoveOne(CalDto calDto) {
        ...
        public Map<String, Boolean> calendarEventModify(CalDto calDto) {
