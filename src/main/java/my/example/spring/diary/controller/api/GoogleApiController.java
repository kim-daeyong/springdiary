...
public class GoogleApiController {
    ...
    private Logger logger = LoggerFactory.getLogger(GoogleApiController.class);
    ...
    public String calendarAdd(CalDto calDto) {
    ...
    public String calendarModify(CalDto calDto) {
